...
int main(int argc, char ** argv){
	...
	const double np_a	  = 0.598628	 ;
	const double np_b	  = 1.68394	 ;
	const double np_c	  = 0.314105	 ;
	const double of_p	  = -2.25666	 ;
	const double of_n	  = 3.82838	 ;
	const double Nhe3	  = 1.01553	 ;
	const double Nh3	  = 0.991685	 ;
	...
	double arrx[20] = {0.};
	double arry[20] = {0.};
	min->Contour(3,4,numpts,arrx,arry);
	cout << numpts << "\n";
