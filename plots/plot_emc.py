...
plt.figure(1)
plt.plot(x,he3_SF,color='red',linestyle='-',label='He-3, SF, Constant Offshell')
plt.plot(x,h3_SF,color='blue',linestyle='-',label='H-3, SF, Constant Offshell')
plt.plot(x,he3_LC,color='red',linestyle='--',label='He-3, LC, Constant Offshell')
plt.plot(x,h3_LC,color='blue',linestyle='--',label='H-3, LC, Constant Offshell')
...
plt.figure(2)
plt.plot(x,he3_no_SF,color='red',linestyle='-',label='He-3, SF, No Offshell')
plt.plot(x, h3_no_SF,color='blue',linestyle='-',label='H-3, SF, No Offshell')
plt.plot(x,he3_no_LC,color='red',linestyle='--',label='He-3, LC, No Offshell')
plt.plot(x, h3_no_LC,color='blue',linestyle='--',label='H-3, LC, No Offshell')
plt.legend(numpoints=1,loc='best')
plt.errorbar(mar_x,mar_he3,yerr=mar_he3e,fmt='ro')
plt.errorbar(mar_x,mar_h3,yerr=mar_h3e,fmt='bo')
plt.grid(True)
